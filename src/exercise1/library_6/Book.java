...
public class Book {
    ...
    public void borrowed(String brwDate) {
        borrowed=true;
        this.date=brwDate;
        //this.returnData=this.title+"not be returned!";
    ...
    public static void main(String[] args){
        ...
        System.out.println("Title (should be The Da Vinci Code): " + example.getTitle()+example.getDate());
        System.out.println("Borrowed? (should be false): " + example.isBorrowed()+" book entry time:"+example.getDate());
        example.borrowed("2011-10-25");
        System.out.println("Borrowed? (should be true): " + example.isBorrowed()+" borrowed on "+example.getDate());
        example.returned("2011-12-06");
        System.out.println("Borrowed? (should be false): " + example.isBorrowed()+" returned on "+example.getDate());
    }
}
